export const categories = [
  {
    ...
    description: "Nossos armários são produzidos com matéria prima de qualidade, conferindo maior durabilidade e resistência.",
    products: [
  ...
  },
  {
    ...
    description: "Em busca de estruturas para armazenar pastas ou fichas? Encontre nesta sessão os móveis necessários",
    products: [
      { name: "A-R4", slug: "a-r4" },
  ...
  },
  {
    ...
    description: "Estrutura robusta para armazenagem eficiente, ideal para organizar cargas paletizadas em diversos ambientes.",
    products: [{ name: "Porta Pallet 500kg", slug: "mini-porta-pallet" }]
  },
  {
    name: "Gondolas",
    singleName: "Gondola",
    slug: "gondolas",
    image: "/assets/products/gondolas/gondola.png",
