        ...
        <section className="tw-px-[5%] tw-pt-[150px] pb-[100px] tw-mt-[-100px]" id="catalogo">
          ...
          <div className="tw-flex tw-items-center tw-justify-around tw-mt-[40px]">
            ...
            <div>
              ...
              <a href="/assets/catalogo.pdf" target="_blank" className="tw-flex tw-items-center hover:tw-underline">
          ...
          <div className="tw-flex tw-items-center tw-justify-around tw-gap-[20px] tw-mt-[40px] tw-max-w-[1280px] tw-mx-auto">
            <div className="tw-w-[50%]">
              <p className="tw-mb-[30px]">
                ...
                Contamos com alta tecnologia na fabricação das próprias matrizes e equipamentos utilizados para moldar e desenvolver nossos móveis, que garante a precisão e o perfeito acabamento refletindo em um diferencial na venda dos produtos GGL.
